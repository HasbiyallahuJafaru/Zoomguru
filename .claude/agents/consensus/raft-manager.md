...
hooks:
  pre: |
    echo "ðŸ—³ï¸  Raft Manager starting: $TASK"
    # Check cluster health before operations
    if [[ "$TASK" == *"election"* ]]; then
      echo "ðŸŽ¯ Preparing leader election process"
    fi
  post: |
    echo "ðŸ“ Raft operation complete"
    # Verify log consistency
    echo "ðŸ” Validating log replication and consistency"
---
